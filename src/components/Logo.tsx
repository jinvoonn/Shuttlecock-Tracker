...
export function Logo({ className, iconOnly = false }: { className?: string, iconOnly?: boolean }) {
    return (
        <div className={clsx("flex items-center gap-3", className)}>
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-emerald-600 shadow-lg shadow-emerald-500/20 shrink-0 flex items-center justify-center text-white relative group overflow-hidden">
